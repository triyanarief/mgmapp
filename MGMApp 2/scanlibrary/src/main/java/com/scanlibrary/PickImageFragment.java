...
public class PickImageFragment extends Fragment {
    ...
    private static final int REQUEST_READ_STORAGE = 125;
    private View view;
    ...
    public void openCamera() {
        ...
        if ( Build.VERSION.SDK_INT >= 23 && ContextCompat.checkSelfPermission( getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE ) != PackageManager.PERMISSION_GRANTED) {
        ...
        Intent cameraIntent = new Intent(this.getActivity(), CameraActivity.class);
